...
#region Khởi tạo
        ...
        public TamGiacVuong(Color mauVe, int doDamNet)
            : base(mauVe, doDamNet)
        {
            soDiemDieuKhien = 8;
            diemBatDau.X = 0; diemBatDau.Y = 0;
        ...
        public TamGiacVuong(Color mauve , int dodamnet , Point diembatdau , Point diemketthuc , Point diemmousedown ,
...
#region Tuần tự hóa và giải tuần tự hóa
        public TamGiacVuong(SerializationInfo info, StreamingContext ctxt)
            : base(info, ctxt)
...
#region Phương thức
        ...
        public override void Ve(Graphics g)
        {
            ...
            {
                Pen pen = new Pen(mauVe, doDamNet);
                g.DrawLine(pen, DiemDieuKhien(3), DiemDieuKhien(8));
                g.DrawLine(pen, DiemDieuKhien(8), DiemDieuKhien(1));
            ...
            {
                Pen pen = new Pen(mauVe, doDamNet);
                g.DrawLine(pen, DiemDieuKhien(1), DiemDieuKhien(6));
