...
#region Khởi tạo
        ...
        public NguGiac(Color mauVe, int doDamNet)
            : base(mauVe, doDamNet)
        {
            soDiemDieuKhien = 8;
            diemBatDau.X = 0; diemBatDau.Y = 0;
        ...
        public NguGiac(Color mauve , int dodamnet , Point diembatdau , Point diemketthuc , Point diemmousedown ,
...
#region Tuần tự hóa và giải tuần tự hóa
        public NguGiac(SerializationInfo info, StreamingContext ctxt)
            : base(info, ctxt)
