...
#region Thuộc tính
        ...
        public Point diemBatDau = new Point();           // Điểm bắt đầu vẽ
        public Point diemKetThuc = new Point();           // Điểm kết thúc vẽ
        ...
        public Region khuVuc = new Region();              // Tạo ra 1 vùng
        ...
        public Image hinhNen;           //hinh import
        public string VanBan;           //add text
#endregion
